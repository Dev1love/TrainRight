...
import { MockTrainingPlanRepository } from '../mocks/MockTrainingPlanRepository';

describe('TrainingPlanService', () => {
    let trainingPlanService: TrainingPlanService;
    let trainingPlanRepository: MockTrainingPlanRepository;

    beforeEach(() => {
        trainingPlanRepository = new MockTrainingPlanRepository();
    ...
    describe('getPlanDetails', () => {
        ...
        it('should return plan with exercises', async () => {
            ...
            expect(plan?.planExercises).toHaveLength(1);
        });
